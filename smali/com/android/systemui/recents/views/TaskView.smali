...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 135
    iput-boolean p2, p0, Lcom/android/systemui/recents/views/TaskView;->mClipViewInStack:Z

    .line 147
    new-instance p2, Lcom/android/systemui/recents/views/TaskViewTransform;

    invoke-direct {p2}, Lcom/android/systemui/recents/views/TaskViewTransform;-><init>()V

    iput-object p2, p0, Lcom/android/systemui/recents/views/TaskView;->mTargetAnimationTransform:Lcom/android/systemui/recents/views/TaskViewTransform;
    ...
    iput-object p2, p0, Lcom/android/systemui/recents/views/TaskView;->mTmpAnimators:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, Lcom/android/systemui/recents/views/TaskView;->mDownTouchPos:Landroid/graphics/Point;
    ...
    iput-object p3, p0, Lcom/android/systemui/recents/views/TaskView;->mViewBounds:Lcom/android/systemui/recents/views/AnimateableViewBounds;

    .line 180
    iget-boolean p3, p2, Lcom/android/systemui/recents/RecentsConfiguration;->fakeShadows:Z

    if-eqz p3, :cond_0

    .line 181
    new-instance p3, Lcom/android/systemui/recents/views/FakeShadowDrawable;

    invoke-direct {p3, p1, p2}, Lcom/android/systemui/recents/views/FakeShadowDrawable;-><init>(Landroid/content/res/Resources;Lcom/android/systemui/recents/RecentsConfiguration;)V

    invoke-virtual {p0, p3}, Landroid/widget/FrameLayout;->setBackground(Landroid/graphics/drawable/Drawable;)V

    .line 183
    :cond_0
    iget-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mViewBounds:Lcom/android/systemui/recents/views/AnimateableViewBounds;
    ...
    .line 185
    new-instance p1, Lcom/android/systemui/recents/views/TaskViewAccessibilityDelegate;

    invoke-direct {p1, p0}, Lcom/android/systemui/recents/views/TaskViewAccessibilityDelegate;-><init>(Lcom/android/systemui/recents/views/TaskView;)V
...
.method static synthetic access$000(Lcom/android/systemui/recents/views/TaskView;)Landroid/view/View;
    ...
    .line 68
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mActionButtonView:Landroid/view/View;
...
.method static synthetic access$100(Lcom/android/systemui/recents/views/TaskView;)Lcom/android/systemui/shared/recents/model/Task;
    ...
    .line 68
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mTask:Lcom/android/systemui/shared/recents/model/Task;
...
.method private cancelDimAnimationIfExists()V
    ...
    .line 368
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mDimAnimator:Landroid/animation/ObjectAnimator;
...
.method public cancelTransformAnimation()V
    ...
    .line 364
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mOutlineAnimator:Landroid/animation/ObjectAnimator;
...
.method dismissTask()V
    ...
    invoke-direct {v1, p0, p0}, Lcom/android/systemui/recents/views/TaskView$5;-><init>(Lcom/android/systemui/recents/views/TaskView;Lcom/android/systemui/recents/views/TaskView;)V
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    const-string p1, " mTask="

    .line 732
    invoke-virtual {p2, p1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mTask:Lcom/android/systemui/shared/recents/model/Task;
    ...
    .line 735
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mThumbnailView:Lcom/android/systemui/recents/views/TaskViewThumbnail;

    invoke-virtual {p0, v0, p2}, Lcom/android/systemui/recents/views/TaskViewThumbnail;->dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
...
.method public getDimAlpha()F
    ...
    .line 455
    iget p0, p0, Lcom/android/systemui/recents/views/TaskView;->mDimAlpha:F
...
.method getViewBounds()Lcom/android/systemui/recents/views/AnimateableViewBounds;
    ...
    .line 216
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mViewBounds:Lcom/android/systemui/recents/views/AnimateableViewBounds;
...
.method public hideActionButton(ZIZLandroid/animation/Animator$AnimatorListener;)V
    ...
    .line 505
    iget-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mActionButtonView:Landroid/view/View;
    ...
    .line 508
    iget-object p3, p0, Lcom/android/systemui/recents/views/TaskView;->mActionButtonView:Landroid/view/View;
    ...
    new-instance p2, Lcom/android/systemui/recents/views/TaskView$6;

    invoke-direct {p2, p0, p4}, Lcom/android/systemui/recents/views/TaskView$6;-><init>(Lcom/android/systemui/recents/views/TaskView;Landroid/animation/Animator$AnimatorListener;)V
...
.method isAnimatingTo(Lcom/android/systemui/recents/views/TaskViewTransform;)Z
    ...
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mTargetAnimationTransform:Lcom/android/systemui/recents/views/TaskViewTransform;

    .line 355
    invoke-virtual {p0, p1}, Lcom/android/systemui/recents/views/TaskViewTransform;->isSame(Lcom/android/systemui/recents/views/TaskViewTransform;)Z
...
.method public synthetic lambda$onBusEvent$0$TaskView()V
    .locals 1
...
.method public synthetic lambda$onBusEvent$1$TaskView()V
    .locals 1
...
.method protected measureContents(II)V
    ...
    iget v1, p0, Landroid/widget/FrameLayout;->mPaddingRight:I
...
.method public final onBusEvent(Lcom/android/systemui/recents/events/ui/dragndrop/DragEndEvent;)V
    ...
    invoke-virtual {p1, p0}, Lcom/android/systemui/recents/events/EventBus;->unregister(Ljava/lang/Object;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mDisabledAppToast:Landroid/widget/Toast;

    .line 661
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mDisabledAppToast:Landroid/widget/Toast;
    ...
    invoke-direct {v2, p0, v3, v4, v1}, Lcom/android/systemui/recents/events/activity/LaunchTaskEvent;-><init>(Lcom/android/systemui/recents/views/TaskView;Lcom/android/systemui/shared/recents/model/Task;Landroid/graphics/Rect;Z)V
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    invoke-virtual {v3}, Lcom/android/systemui/recents/views/AnimateableViewBounds;->getClipBounds()Landroid/graphics/Rect;
    ...
    invoke-virtual {v2, v5, v3}, Landroid/graphics/Rect;->contains(II)Z
    ...
    .line 693
    :cond_1
    iget-object v2, p0, Lcom/android/systemui/recents/views/TaskView;->mDownTouchPos:Landroid/graphics/Point;
    ...
    .line 699
    iget-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mDownTouchPos:Landroid/graphics/Point;
    ...
    invoke-virtual {p1, p0, v0}, Lcom/android/systemui/recents/events/EventBus;->register(Ljava/lang/Object;I)V
    ...
    new-instance v0, Lcom/android/systemui/recents/events/ui/dragndrop/DragStartEvent;

    iget-object v1, p0, Lcom/android/systemui/recents/views/TaskView;->mTask:Lcom/android/systemui/shared/recents/model/Task;

    iget-object v2, p0, Lcom/android/systemui/recents/views/TaskView;->mDownTouchPos:Landroid/graphics/Point;

    invoke-direct {v0, v1, p0, v2}, Lcom/android/systemui/recents/events/ui/dragndrop/DragStartEvent;-><init>(Lcom/android/systemui/shared/recents/model/Task;Lcom/android/systemui/recents/views/TaskView;Landroid/graphics/Point;)V
...
.method public onPrepareLaunchTargetForEnterAnimation()V
    ...
    .line 544
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mIncompatibleAppToastView:Landroid/view/View;
...
.method protected onSizeChanged(IIII)V
    ...
    .line 249
    iget-object p3, p0, Lcom/android/systemui/recents/views/TaskView;->mHeaderView:Lcom/android/systemui/recents/views/TaskViewHeader;

    invoke-virtual {p3, p1, p2}, Lcom/android/systemui/recents/views/TaskViewHeader;->onTaskViewSizeChanged(II)V

    .line 250
    iget-object p3, p0, Lcom/android/systemui/recents/views/TaskView;->mThumbnailView:Lcom/android/systemui/recents/views/TaskViewThumbnail;

    invoke-virtual {p3, p1, p2}, Lcom/android/systemui/recents/views/TaskViewThumbnail;->onTaskViewSizeChanged(II)V
...
.method public onStartFrontTaskEnterAnimation(Z)V
    ...
    .line 595
    invoke-virtual {p0, p1, p1}, Lcom/android/systemui/recents/views/TaskView;->showActionButton(ZI)V
...
.method public onStartLaunchTargetEnterAnimation(Lcom/android/systemui/recents/views/TaskViewTransform;IZLcom/android/systemui/recents/misc/ReferenceCountedTrigger;)V
    ...
    invoke-direct {v0, p2, v1}, Lcom/android/systemui/recents/utilities/AnimationProps;-><init>(ILandroid/view/animation/Interpolator;)V
    ...
    iget p1, p1, Lcom/android/systemui/recents/views/TaskViewTransform;->dimAlpha:F
    ...
    invoke-virtual {v0, v1, p1}, Lcom/android/systemui/recents/utilities/AnimationProps;->apply(ILandroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;

    check-cast p1, Landroid/animation/ObjectAnimator;

    iput-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mDimAnimator:Landroid/animation/ObjectAnimator;

    .line 558
    iget-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mDimAnimator:Landroid/animation/ObjectAnimator;
    ...
    .line 562
    invoke-virtual {p0, v3, p2}, Lcom/android/systemui/recents/views/TaskView;->showActionButton(ZI)V

    .line 565
    :cond_0
    iget-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mIncompatibleAppToastView:Landroid/view/View;
...
.method public onStartLaunchTargetLaunchAnimation(IZLcom/android/systemui/recents/misc/ReferenceCountedTrigger;)V
    ...
    invoke-direct {v0, p1, v1}, Lcom/android/systemui/recents/utilities/AnimationProps;-><init>(ILandroid/view/animation/Interpolator;)V
    ...
    invoke-virtual {v0, v2, v1}, Lcom/android/systemui/recents/utilities/AnimationProps;->apply(ILandroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    .line 587
    invoke-virtual {p0, v3, p1, p2, p3}, Lcom/android/systemui/recents/views/TaskView;->hideActionButton(ZIZLandroid/animation/Animator$AnimatorListener;)V
...
.method public onTaskBound(Lcom/android/systemui/shared/recents/model/Task;ZILandroid/graphics/Rect;)V
    ...
    .line 606
    iput-boolean p2, p0, Lcom/android/systemui/recents/views/TaskView;->mTaskBound:Z

    .line 607
    iget-object v1, p0, Lcom/android/systemui/recents/views/TaskView;->mTask:Lcom/android/systemui/shared/recents/model/Task;

    invoke-virtual {v1, p0}, Lcom/android/systemui/shared/recents/model/Task;->addCallback(Lcom/android/systemui/shared/recents/model/Task$TaskCallbacks;)V

    .line 608
    iget-object v1, p0, Lcom/android/systemui/recents/views/TaskView;->mTask:Lcom/android/systemui/shared/recents/model/Task;

    iget-boolean v1, v1, Lcom/android/systemui/shared/recents/model/Task;->isSystemApp:Z
    ...
    :goto_0
    iput-boolean p2, p0, Lcom/android/systemui/recents/views/TaskView;->mIsDisabledInSafeMode:Z

    .line 609
    iget-object p2, p0, Lcom/android/systemui/recents/views/TaskView;->mThumbnailView:Lcom/android/systemui/recents/views/TaskViewThumbnail;

    iget-object v1, p0, Lcom/android/systemui/recents/views/TaskView;->mTask:Lcom/android/systemui/shared/recents/model/Task;

    iget-boolean v3, p0, Lcom/android/systemui/recents/views/TaskView;->mIsDisabledInSafeMode:Z

    invoke-virtual {p2, v1, v3, p3, p4}, Lcom/android/systemui/recents/views/TaskViewThumbnail;->bindToTask(Lcom/android/systemui/shared/recents/model/Task;ZILandroid/graphics/Rect;)V

    .line 610
    iget-object p2, p0, Lcom/android/systemui/recents/views/TaskView;->mHeaderView:Lcom/android/systemui/recents/views/TaskViewHeader;

    iget-object p3, p0, Lcom/android/systemui/recents/views/TaskView;->mTask:Lcom/android/systemui/shared/recents/model/Task;

    iget-boolean p4, p0, Lcom/android/systemui/recents/views/TaskView;->mTouchExplorationEnabled:Z

    iget-boolean v1, p0, Lcom/android/systemui/recents/views/TaskView;->mIsDisabledInSafeMode:Z

    invoke-virtual {p2, p3, p4, v1}, Lcom/android/systemui/recents/views/TaskViewHeader;->bindToTask(Lcom/android/systemui/shared/recents/model/Task;ZZ)V
    ...
    .line 614
    invoke-static {p0, p1}, Lcom/android/systemui/recents/utilities/Utilities;->findViewStubById(Landroid/view/View;I)Landroid/view/ViewStub;
    ...
    iput-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mIncompatibleAppToastView:Landroid/view/View;
...
.method public onTaskDataLoaded(Lcom/android/systemui/shared/recents/model/Task;Lcom/android/systemui/shared/recents/model/ThumbnailData;)V
    ...
    .line 627
    iget-boolean p1, p0, Lcom/android/systemui/recents/views/TaskView;->mTaskBound:Z

    if-eqz p1, :cond_0

    .line 629
    iget-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mThumbnailView:Lcom/android/systemui/recents/views/TaskViewThumbnail;

    invoke-virtual {p1, p2}, Lcom/android/systemui/recents/views/TaskViewThumbnail;->onTaskDataLoaded(Lcom/android/systemui/shared/recents/model/ThumbnailData;)V

    .line 630
    iget-object p0, p0, Lcom/android/systemui/recents/views/TaskView;->mHeaderView:Lcom/android/systemui/recents/views/TaskViewHeader;

    invoke-virtual {p0}, Lcom/android/systemui/recents/views/TaskViewHeader;->onTaskDataLoaded()V
...
.method resetNoUserInteractionState()V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/recents/views/TaskViewHeader;->resetNoUserInteractionState()V
...
.method resetViewProperties()V
    ...
    invoke-virtual {v1}, Lcom/android/systemui/recents/views/AnimateableViewBounds;->reset()V
...
.method setClipViewInStack(Z)V
    ...
    .line 424
    iget-object p1, p0, Lcom/android/systemui/recents/views/TaskView;->mCb:Lcom/android/systemui/recents/views/TaskView$TaskViewCallbacks;

    if-eqz p1, :cond_0

    .line 425
    invoke-interface {p1, p0}, Lcom/android/systemui/recents/views/TaskView$TaskViewCallbacks;->onTaskViewClipStateChanged(Lcom/android/systemui/recents/views/TaskView;)V
...
.method public setDimAlpha(F)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/systemui/recents/views/TaskViewHeader;->setDimAlpha(F)V
...
.method public setDimAlphaWithoutHeader(F)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/systemui/recents/views/TaskViewThumbnail;->setDimAlpha(F)V
...
.method public setFocusedState(ZZ)V
    ...
    iget-boolean p1, p0, Lcom/android/systemui/recents/views/TaskView;->mTouchExplorationEnabled:Z

    if-eqz p1, :cond_1

    .line 468
    invoke-virtual {p0}, Landroid/widget/FrameLayout;->clearAccessibilityFocus()V
...
.method shouldClipViewInStack()Z
    ...
    .line 417
    :cond_0
    iget-boolean p0, p0, Lcom/android/systemui/recents/views/TaskView;->mClipViewInStack:Z
...
.method public showActionButton(ZI)V
    ...
    iget p0, p0, Lcom/android/systemui/recents/views/TaskView;->mActionButtonTranslationZ:F
...
.method public startNoUserInteractionAnimation()V
    ...
    invoke-virtual {p0}, Lcom/android/systemui/recents/views/TaskViewHeader;->startNoUserInteractionAnimation()V

    return-void
.end method

.method updateViewPropertiesToTaskTransform(Lcom/android/systemui/recents/views/TaskViewTransform;Lcom/android/systemui/recents/utilities/AnimationProps;Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V
    .locals 7
    ...
    invoke-virtual {p1, p0, v1, p2, v0}, Lcom/android/systemui/recents/views/TaskViewTransform;->applyToTaskView(Lcom/android/systemui/recents/views/TaskView;Ljava/util/ArrayList;Lcom/android/systemui/recents/utilities/AnimationProps;Z)V

    .line 291
    invoke-virtual {p2}, Lcom/android/systemui/recents/utilities/AnimationProps;->isImmediate()Z
    ...
    iget v1, p1, Lcom/android/systemui/recents/views/TaskViewTransform;->viewOutlineAlpha:F
    ...
    iget p1, p1, Lcom/android/systemui/recents/views/TaskViewTransform;->viewOutlineAlpha:F

    invoke-virtual {p0, p1}, Lcom/android/systemui/recents/views/AnimateableViewBounds;->setAlpha(F)V

    .line 299
    :cond_1
    invoke-virtual {p2}, Lcom/android/systemui/recents/utilities/AnimationProps;->getListener()Landroid/animation/Animator$AnimatorListener;
    ...
    .line 303
    invoke-interface {p3, p1}, Landroid/animation/ValueAnimator$AnimatorUpdateListener;->onAnimationUpdate(Landroid/animation/ValueAnimator;)V
    ...
    .line 308
    sget-object v0, Lcom/android/systemui/recents/views/TaskView;->DIM_ALPHA:Landroid/util/Property;
    ...
    iput-object v0, p0, Lcom/android/systemui/recents/views/TaskView;->mDimAnimator:Landroid/animation/ObjectAnimator;

    .line 310
    iget-object v0, p0, Lcom/android/systemui/recents/views/TaskView;->mTmpAnimators:Ljava/util/ArrayList;

    iget-object v5, p0, Lcom/android/systemui/recents/views/TaskView;->mDimAnimator:Landroid/animation/ObjectAnimator;

    invoke-virtual {p2, v3, v5}, Lcom/android/systemui/recents/utilities/AnimationProps;->apply(ILandroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    .line 313
    sget-object v0, Lcom/android/systemui/recents/views/TaskView;->VIEW_OUTLINE_ALPHA:Landroid/util/Property;
    ...
    iput-object v0, p0, Lcom/android/systemui/recents/views/TaskView;->mOutlineAnimator:Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {p2, v3, v1}, Lcom/android/systemui/recents/utilities/AnimationProps;->apply(ILandroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    .line 320
    iget-object p3, p0, Lcom/android/systemui/recents/views/TaskView;->mTmpAnimators:Ljava/util/ArrayList;

    invoke-virtual {p2, v3, v0}, Lcom/android/systemui/recents/utilities/AnimationProps;->apply(ILandroid/animation/ValueAnimator;)Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {p2, p3}, Lcom/android/systemui/recents/utilities/AnimationProps;->createAnimator(Ljava/util/List;)Landroid/animation/AnimatorSet;

    move-result-object p2

    iput-object p2, p0, Lcom/android/systemui/recents/views/TaskView;->mTransformAnimation:Landroid/animation/AnimatorSet;

    .line 325
    iget-object p2, p0, Lcom/android/systemui/recents/views/TaskView;->mTransformAnimation:Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, p1}, Lcom/android/systemui/recents/views/TaskViewTransform;->copyFrom(Lcom/android/systemui/recents/views/TaskViewTransform;)V
