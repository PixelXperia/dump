...
.method constructor <init>(IIIIILandroid/graphics/RectF;Landroid/graphics/RectF;Landroid/graphics/RectF;)V
    ...
    .line 261
    new-instance p1, Lcom/android/systemui/recents/views/DockState$ViewState;
    ...
    iput-object p1, p0, Lcom/android/systemui/recents/views/DockState;->viewState:Lcom/android/systemui/recents/views/DockState$ViewState;
...
.method private getMappedRect(Landroid/graphics/RectF;IILandroid/graphics/Rect;)V
    ...
    invoke-virtual {p4, p0, v0, p2, p1}, Landroid/graphics/Rect;->set(IIII)V
...
.method private updateBoundsWithSystemInsets(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .line 336
    iget p0, p0, Lcom/android/systemui/recents/views/DockState;->dockSide:I
...
.method public acceptsDrop(IIIILandroid/graphics/Rect;Z)Z
    ...
    .line 94
    iget-object p5, p0, Lcom/android/systemui/recents/views/DockState;->expandedTouchDockArea:Landroid/graphics/RectF;

    sget-object p6, Lcom/android/systemui/recents/views/DockState;->mTmpRect:Landroid/graphics/Rect;

    invoke-direct {p0, p5, p3, p4, p6}, Lcom/android/systemui/recents/views/DockState;->getMappedRect(Landroid/graphics/RectF;IILandroid/graphics/Rect;)V

    .line 95
    sget-object p0, Lcom/android/systemui/recents/views/DockState;->mTmpRect:Landroid/graphics/Rect;
    ...
    .line 97
    :cond_0
    iget-object p6, p0, Lcom/android/systemui/recents/views/DockState;->touchArea:Landroid/graphics/RectF;

    sget-object v0, Lcom/android/systemui/recents/views/DockState;->mTmpRect:Landroid/graphics/Rect;

    invoke-direct {p0, p6, p3, p4, v0}, Lcom/android/systemui/recents/views/DockState;->getMappedRect(Landroid/graphics/RectF;IILandroid/graphics/Rect;)V

    .line 98
    sget-object p3, Lcom/android/systemui/recents/views/DockState;->mTmpRect:Landroid/graphics/Rect;

    invoke-direct {p0, p3, p5}, Lcom/android/systemui/recents/views/DockState;->updateBoundsWithSystemInsets(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
...
.method public getDockedTaskStackBounds(Landroid/graphics/Rect;IIILandroid/graphics/Rect;Lcom/android/systemui/recents/views/TaskStackLayoutAlgorithm;Landroid/content/res/Resources;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .line 310
    :goto_0
    invoke-static {v5, v1, v2, v4, v10}, Lcom/android/internal/policy/DockedDividerUtils;->calculateMiddlePosition(ZLandroid/graphics/Rect;III)I

    move-result v5

    .line 312
    iget v6, v0, Lcom/android/systemui/recents/views/DockState;->dockSide:I
    ...
    .line 312
    invoke-static/range {v5 .. v10}, Lcom/android/internal/policy/DockedDividerUtils;->calculateBoundsForPosition(IILandroid/graphics/Rect;III)V
    ...
    .line 320
    iget-object v0, v0, Lcom/android/systemui/recents/views/DockState;->dockArea:Landroid/graphics/RectF;
    ...
    invoke-virtual/range {v7 .. v13}, Lcom/android/systemui/recents/views/TaskStackLayoutAlgorithm;->getTaskStackBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;IIILandroid/graphics/Rect;)V
...
.method public getPreDockedBounds(IILandroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    .line 280
    sget-object p1, Lcom/android/systemui/recents/views/DockState;->mTmpRect:Landroid/graphics/Rect;

    invoke-direct {p0, p1, p3}, Lcom/android/systemui/recents/views/DockState;->updateBoundsWithSystemInsets(Landroid/graphics/Rect;Landroid/graphics/Rect;)Landroid/graphics/Rect;
...
.method public update(Landroid/content/Context;)V
    ...
    .line 272
    iget-object p0, p0, Lcom/android/systemui/recents/views/DockState;->viewState:Lcom/android/systemui/recents/views/DockState$ViewState;

    invoke-virtual {p0, p1}, Lcom/android/systemui/recents/views/DockState$ViewState;->update(Landroid/content/Context;)V
