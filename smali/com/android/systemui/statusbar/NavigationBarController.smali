...
.method private removeNavigationBar(I)V
    ...
    invoke-virtual {v1}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->getLockController()Lcom/android/systemui/statusbar/phone/NavigationBarLockController;

    move-result-object v1

    invoke-interface {v1}, Lcom/android/systemui/statusbar/phone/NavigationBarLockController;->destroy()V
...
.method createNavigationBar(Landroid/view/Display;Lcom/android/internal/statusbar/RegisterStatusBarResult;)V
    ...
    iput-object p1, p0, Lcom/android/systemui/statusbar/NavigationBarController;->mNavigationBarView:Landroid/view/View;
...
.method public createNavigationBars(ZLcom/android/internal/statusbar/RegisterStatusBarResult;)V
    ...
    .line 116
    :cond_2
    iget-object v3, p0, Lcom/android/systemui/statusbar/NavigationBarController;->mNavigationBarView:Landroid/view/View;
    ...
    sget v7, Lcom/android/systemui/R$id;->recent_apps:I

    sget v8, Lcom/android/systemui/R$id;->menu:I

    sget v9, Lcom/android/systemui/R$id;->ime_switcher:I

    sget v10, Lcom/android/systemui/R$id;->accessibility_button:I

    sget v11, Lcom/android/systemui/R$id;->rotate_suggestion:I

    .line 117
    invoke-static/range {v3 .. v11}, Lcom/sonymobile/runtimeskinning/SkinningBridge;->init(Landroid/view/View;IIIIIIII)V
...
.method public synthetic lambda$createNavigationBar$0$NavigationBarController(ZLandroid/content/Context;ILcom/android/internal/statusbar/RegisterStatusBarResult;Landroid/view/Display;Ljava/lang/String;Landroid/app/Fragment;)V
    ...
    .line 154
    invoke-virtual {p6}, Landroid/app/Fragment;->getView()Landroid/view/View;

    move-result-object p7

    check-cast p7, Lcom/android/systemui/statusbar/phone/NavigationBarView;

    if-eqz p1, :cond_0

    .line 157
    const-class v0, Lcom/android/systemui/statusbar/phone/NavigationBarLockController;

    invoke-static {v0}, Lcom/android/systemui/Dependency;->get(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/android/systemui/statusbar/phone/NavigationBarLockController;

    goto :goto_0

    .line 158
    :cond_0
    new-instance v0, Lcom/android/systemui/statusbar/phone/NavigationBarLockControllerImpl;

    invoke-direct {v0, p2}, Lcom/android/systemui/statusbar/phone/NavigationBarLockControllerImpl;-><init>(Landroid/content/Context;)V

    .line 159
    :goto_0
    invoke-virtual {p7, v0}, Lcom/android/systemui/statusbar/phone/NavigationBarView;->setLockController(Lcom/android/systemui/statusbar/phone/NavigationBarLockController;)V

    .line 160
    invoke-interface {v0, p7}, Lcom/android/systemui/statusbar/phone/NavigationBarLockController;->setNavigationBarView(Lcom/android/systemui/statusbar/phone/NavigationBarView;)V
